...
/// \file simple_text_data.ipp
/// Contains implementation of basic_simple_text_data class.
...
basic_simple_text_data<Char>::basic_simple_text_data() {
    lines_.push_back(std::make_shared<line_t>());
}


template <typename Char>
basic_simple_text_data<Char>::basic_simple_text_data(characters_range<Char> auto && chars) {
    reset(chars);
}


template <typename Char>
void basic_simple_text_data<Char>::reset(characters_range<Char> auto && chars) {
...
template <typename Char>
range basic_simple_text_data<Char>::insert(const position & p,
...
template <typename Char>
void basic_simple_text_data<Char>::erase(const range & r) {
...
template <typename Char>
void basic_simple_text_data<Char>::replace(const position & p,
                                            characters_range<Char> auto && chars) {
